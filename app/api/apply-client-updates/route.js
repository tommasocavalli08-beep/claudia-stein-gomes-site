...
export async function GET(){
  try{
    ...
    settings.treatmentVideos['cirurgia-varizes-local-sedacao']={videos:[{youtubeId:'_fEX8P01nbs',vertical:true,label:'Cirurgia de varizes com local e sedação'}]};
    settings.treatmentVideos.pressoterapia={videos:[{youtubeId:'t-zK6aJN_DY',vertical:true,label:'Pressoterapia'}]};
